...
def normalize_stem(name):
    ...
    suffixes = [
        "_disparity_vis_vis_2d_landmark",
        "_disparity_vis_left_rectified",
        "_disparity_vis_left_raw",
        "_disparity_vis_landmarks",
        "_disparity_vis_landmark",
        "_disparity_vis_axis",
        "_disparity_vis_pose",
        "_disparity_vis_overlay",
        "_disparity_vis_disparity_vis",
        "_vis_2d_landmark",
        "_left_rectified",
        "_left_raw",
        "_landmarks",
